...
class StorageManager:
    ...
    def upload_image(self, image_data: bytes, filename: str, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        """
        logger.info(f"Starting image upload: {filename}")
        ...
        try:
            ...
            logger.debug(f"Uploading to bucket '{self.bucket_name}' with filename '{unique_filename}'")
            
            # Note: The exact API method may vary based on the Replit Object Storage SDK
            # This is based on typical object storage patterns
            ...
            return {
                ...
                'metadata': upload_metadata,
                'url': f"gs://{self.bucket_name}/{unique_filename}"  # GCS-style URL
            }
    ...
    def _save_locally(self, image_data: bytes, filename: str, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        """
        logger.info(f"Saving image locally (development mode): {filename}")
    ...
    def list_uploaded_images(self) -> Dict[str, Any]:
        ...
        """
        logger.info("Listing uploaded images")
